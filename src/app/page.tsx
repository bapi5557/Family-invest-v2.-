    ...
    <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center p-4">
      <div className="max-w-md w-full space-y-8 animate-in fade-in zoom-in duration-500">
        <div className="text-center">
          ...
          <p className="text-muted-foreground mt-2 font-medium">Shared Family Investment Manager</p>
        </div>

        <Card className="p-8 shadow-2xl border-none">
          <div className="space-y-6 text-center">
            <div className="space-y-2">
              <h2 className="text-xl font-bold">One Account for the Whole Family</h2>
              <p className="text-sm text-muted-foreground">Manage expenses and track investments together. Use shared credentials for instant family-wide sync.</p>
            </div>

            <div className="space-y-3">
              <Button className="w-full h-12 text-lg shadow-lg" asChild>
                <Link href="/login">Family Login</Link>
              </Button>
        ...
        <div className="grid grid-cols-3 gap-4 text-center mt-12">
          ...
          <div className="flex flex-col items-center gap-2">
            ...
            <span className="text-[10px] uppercase font-bold text-slate-400">Sync</span>
          </div>
          <div className="flex flex-col items-center gap-2">
